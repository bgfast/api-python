...
albums = [ 
    Album(1, "You, Me and an App Id Python", "Daprize Python", 10.99, "https://aka.ms/albums-daprlogo"),
    Album(2, "Seven Revision Army Python", "The Blue-Green Stripes Python", 13.99, "https://aka.ms/albums-containerappslogo"),
